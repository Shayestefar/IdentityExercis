...
namespace Simple
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<IdentitySettings>(options => Configuration.GetSection(nameof(IdentitySettings)));
            ...
            services.AddDefaultIdentity<User>(options =>
                ...
                //.AddRoles<RoleManager<Role>>()
                .AddUserStore<IUserStore<AppUserStore>>()
                .AddRoleStore<IRoleStore<AppRoleStore>>()
                .AddRoleManager<RoleManager<AppRoleManager>>()
                .AddUserManager<UserManager<AppUserManager>>()
                .AddSignInManager<SignInManager<AppSignInManager>>()
                .AddUserValidator<IUserValidator<AppUserValidator>>()
                .AddRoleValidator<IRoleValidator<AppRoleValidator>>()
            ;
